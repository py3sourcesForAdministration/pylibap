...
if __name__ == "__main__":
  ...
  import os
  try:
    srcdir = os.environ['MYPYSRC']
    libdir = os.environ['MYPYLIB']
  except KeyError:
    srcdir = os.environ['MYPYSRC'] = os.path.join(os.environ["HOME"],'pysrc')
    libdir = os.environ['MYPYLIB'] = os.path.join(os.environ["HOME"],'pysrc/LIBS')
